...
public class IncidentDao {
    ...
    public ArrayList<IncidentDto> incidentFindAll(){
        ...
        try{
            String sql =
                    "SELECT i.*, c.companyName, ind.industryName " +
                            "FROM incident i " +
            ...
            while(rs.next()){
                ...
                incidentDtos.add(new IncidentDto(
                        incidentId, companyName, industryName, incidentType, incidentDate, approvalStatus
                ));
            }
        } catch (SQLException e) {
    ...
    public ArrayList<IncidentDto> incidentFindOne(int incidentId){
        ...
        try {
            ...
            if(rs.next()) {
                ...
                incidentDtos.add(new IncidentDto(
                        rsId, companyName, industryName, incidentType, incidentDate,
                        approvalStatus, incidentDescription, actionTaken
                ));
            }
        } catch (SQLException e) {
            System.out.println("[시스템오류] SQL 문법 문제 발생: " + e);
